...
function deleteProofImgVehicleTr(elem){
	var parent1=elem.parentNode.parentNode;
	parent1.innerHTML="";
	}

function addProofImgVehicle(elem,proofno) {
   ...
   var jelem=$(elem);
	...
	imgBtn.setAttribute("name","vehicleProofImg["+proofno+"][]");
	...
	scanBtn.setAttribute("class","btn scanBtn vehicleScanBtn");
	scanBtn.setAttribute("onclick","scanVehicleProof(this,'"+proofno+"')");
	...
	removeScanBtn.setAttribute("onclick","deleteProofImgVehicleTr(this)");
